...
class FiftyPercentPage extends StatefulWidget {
  const FiftyPercentPage({Key? key}) : super(key: key);

  @override
  State<FiftyPercentPage> createState() => _FiftyPercentPageState();
}

class _FiftyPercentPageState extends State<FiftyPercentPage> {


  FirebaseFirestore firestoreRef = FirebaseFirestore.instance;
  FirebaseStorage storageRef = FirebaseStorage.instance;
  String collectionName = 'fifty';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text("50% Offer Items are displayed here",style: TextStyle(color: Colors.white,fontSize: 16),),
      ),
              ...
              child: Column(
                ...
                children: [
                  Padding(
                    ...
                    child: Image.asset("assets/icon50.png",height: 180,width: 225,fit: BoxFit.cover,),
                  ),
