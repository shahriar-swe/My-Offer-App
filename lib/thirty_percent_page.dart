...
class ThirtyPercentPage extends StatefulWidget {
  const ThirtyPercentPage({Key? key}) : super(key: key);

  @override
  State<ThirtyPercentPage> createState() => _ThirtyPercentPageState();
}

class _ThirtyPercentPageState extends State<ThirtyPercentPage> {


  FirebaseFirestore firestoreRef = FirebaseFirestore.instance;
  FirebaseStorage storageRef = FirebaseStorage.instance;
  String collectionName = 'thirty';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text("30% Offer Items are displayed here",style: TextStyle(color: Colors.white,fontSize: 16),),
      ),
              ...
              child: Column(
                ...
                children: [
                  Padding(
                    ...
                    child: Image.asset("assets/icon30.png",height: 180,width: 225,fit: BoxFit.cover,),
                  ),
