...
class TwentyFivePercentPage extends StatefulWidget {
  const TwentyFivePercentPage({Key? key}) : super(key: key);

  @override
  State<TwentyFivePercentPage> createState() => _TwentyFivePercentPageState();
}

class _TwentyFivePercentPageState extends State<TwentyFivePercentPage> {


  FirebaseFirestore firestoreRef = FirebaseFirestore.instance;
  FirebaseStorage storageRef = FirebaseStorage.instance;
  String collectionName = 'twenty_five';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text("25% Offer Items are displayed here",style: TextStyle(color: Colors.white,fontSize: 16),),
      ),
              ...
              child: Column(
                ...
                children: [
                  Padding(
                    ...
                    child: Image.asset("assets/icon25.png",height: 180,width: 225,fit: BoxFit.cover,),
                  ),
