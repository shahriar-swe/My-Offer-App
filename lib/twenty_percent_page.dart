...
class TwentyPercentPage extends StatefulWidget {
  const TwentyPercentPage({Key? key}) : super(key: key);

  @override
  State<TwentyPercentPage> createState() => _TwentyPercentPageState();
}

class _TwentyPercentPageState extends State<TwentyPercentPage> {

  FirebaseFirestore firestoreRef = FirebaseFirestore.instance;
  FirebaseStorage storageRef = FirebaseStorage.instance;
  String collectionName = 'twenty';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text("20% Offer Items are displayed here",style: TextStyle(color: Colors.white,fontSize: 16),),
      ),
              ...
              child: Column(
                ...
                children: [
                  Padding(
                    ...
                    child: Image.asset("assets/icon20.png",height: 180,width: 225,fit: BoxFit.cover,),
                  ),
