...
class ThirtyFivePercentPage extends StatefulWidget {
  const ThirtyFivePercentPage({Key? key}) : super(key: key);

  @override
  State<ThirtyFivePercentPage> createState() => _ThirtyFivePercentPageState();
}

class _ThirtyFivePercentPageState extends State<ThirtyFivePercentPage> {


  FirebaseFirestore firestoreRef = FirebaseFirestore.instance;
  FirebaseStorage storageRef = FirebaseStorage.instance;
  String collectionName = 'thirty_five';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text("35% Offer Items are displayed here",style: TextStyle(color: Colors.white,fontSize: 16),),
      ),
              ...
              child: Column(
                ...
                children: [
                  Padding(
                    ...
                    child: Image.asset("assets/icon35.png",height: 180,width: 225,fit: BoxFit.cover,),
                  ),
