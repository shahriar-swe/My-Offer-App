...
class FourtyPercentPage extends StatefulWidget {
  const FourtyPercentPage({Key? key}) : super(key: key);

  @override
  State<FourtyPercentPage> createState() => _FourtyPercentPageState();
}

class _FourtyPercentPageState extends State<FourtyPercentPage> {


  FirebaseFirestore firestoreRef = FirebaseFirestore.instance;
  FirebaseStorage storageRef = FirebaseStorage.instance;
  String collectionName = 'fourty';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text("40% Offer Items are displayed here",style: TextStyle(color: Colors.white,fontSize: 16),),
      ),
              ...
              child: Column(
                ...
                children: [
                  Padding(
                    ...
                    child: Image.asset("assets/icon40.png",height: 180,width: 225,fit: BoxFit.cover,),
                  ),
