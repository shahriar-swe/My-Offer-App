...
class FifteenPercentPage extends StatefulWidget {
  const FifteenPercentPage({Key? key}) : super(key: key);

  @override
  State<FifteenPercentPage> createState() => _FifteenPercentPageState();
}

class _FifteenPercentPageState extends State<FifteenPercentPage> {


  FirebaseFirestore firestoreRef = FirebaseFirestore.instance;
  FirebaseStorage storageRef = FirebaseStorage.instance;
  String collectionName = 'fifteen';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text("15% Offer Items are displayed here",style: TextStyle(color: Colors.white,fontSize: 16),),
      ),
              ...
              child: Column(
                ...
                children: [
                  Padding(
                    ...
                    child: Image.asset("assets/icon15.png",height: 180,width: 225,fit: BoxFit.cover,),
                  ),
