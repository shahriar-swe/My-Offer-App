...
class FivePercentPage extends StatefulWidget {
  const FivePercentPage({Key? key}) : super(key: key);

  @override
  State<FivePercentPage> createState() => _FivePercentPageState();
}

class _FivePercentPageState extends State<FivePercentPage> {



  FirebaseFirestore firestoreRef = FirebaseFirestore.instance;
  FirebaseStorage storageRef = FirebaseStorage.instance;
  String collectionName = 'five';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text("5% Offer Items are displayed here",style: TextStyle(color: Colors.white,fontSize: 16),),
      ),
              ...
              child: Column(
                ...
                children: [
                  Padding(
                    ...
                    child: Image.asset("assets/icon5.png",height: 180,width: 225,fit: BoxFit.cover,),
                  ),
